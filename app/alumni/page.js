          ...
          <div className={styles.batch} id="b_2013">
            ...
            <div className={styles.peoples}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C4D03AQGcu8ZfTIRmmg/profile-displayphoto-shrink_400_400/0/1628674144581?e=1699488000&v=beta&t=n7bwQ6Qad_eKmOLSTKNAAJeGpFME5yRhmmug_dvI-Rg"
                  className={styles.photo}
                />
                <div className={styles.text}>
                  ...
                  <div className={styles.blur}>
                    ...
                    <a
                      className={styles.link}
                      href="https://www.linkedin.com/in/avinash-kumar-singh-5276a7105"
                    >
                      <BiLogoLinkedinSquare />
                    </a>
                  </div>
                  <p></p>
                  <p>Delhi Metro Rail Corporation</p>
                  <a href="" className={styles.link}>
                    <BiLogoLinkedinSquare />
                  </a>
                </div>
              ...
              <div className={styles.people}>
                ...
                <div className={styles.text}>
                  ...
                  <p></p>
                  <p>Associate at State Bank of India</p>
                  <a href="" className={styles.link}>
                    <BiLogoLinkedinSquare />
                  </a>
                </div>
              ...
              <div className={styles.people}>
                ...
                <div className={styles.text}>
                  ...
                  <p></p>
                  <p>Researcher at TCS R&I labs</p>
                  <a
                    href="https://www.linkedin.com/in/avinash-kumar-singh-5276a7105"
                    className={styles.link}
                  >
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C5103AQEvZuCOxAq_ng/profile-displayphoto-shrink_800_800/0/1563195324133?e=1699488000&v=beta&t=POFOcuTFyD7lpFpOMZZZK9rpOA_5XZgeTTSJAKsbaxU"
                  className={styles.photo}
                />
                <div className={styles.text}>
                  ...
                  <div className={styles.blur}>
                    ...
                    <a
                      className={styles.link}
                      href="https://www.linkedin.com/in/soni-kumari-bba724128"
                    >
                      <BiLogoLinkedinSquare />
                    </a>
                  </div>
          ...
          <div className={styles.batch} id="b_2012">
            ...
            <div className={styles.peoples}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C4E03AQHKDm3PVl9qaQ/profile-displayphoto-shrink_800_800/0/1517375813035?e=1699488000&v=beta&t=uTr7qYPINCMuKL-0KmfcrKFXVNL3aJ_w8imgOzC1MQA"
                  className={styles.photo}
                />
                <div className={styles.text}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C4D03AQHOLp43iDnU8A/profile-displayphoto-shrink_800_800/0/1657309458043?e=1699488000&v=beta&t=JO6Z1lM7EQSogwmtbk8OwwJRbMc0Yxrhmc-leGF7qRA"
                  className={styles.photo}
                />
                <div className={styles.text}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C5103AQHJ06G_6ttaPg/profile-displayphoto-shrink_800_800/0/1516949883663?e=1699488000&v=beta&t=1ZJkZJuO99w0u8Uu9b3jJzCMhUIjukq9ZBsfQ1sKjfw"
                  className={styles.photo}
                />
                <div className={styles.text}>
              ...
              <div className={styles.people}>
                <img alt="" src="" className={styles.photo} />
                <div className={styles.text}>
                  <p className={styles.name}>Jagjit Singh Dhadial</p>
                  <div className={styles.blur}>
                    <span>Jagjit Singh Dhadial</span>
                    <img alt="" src="" className={styles.brand} />
                    <a className={styles.link} href="">
                      <BiLogoLinkedinSquare />
                    </a>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C5103AQEHZ5c2k0eZdA/profile-displayphoto-shrink_800_800/0/1536243403024?e=1699488000&v=beta&t=3pYs1e1yaUZYRmVaUCdZG_QDjFcH-7gApPnobfDsfhs"
                  className={styles.photo}
                />
                <div className={styles.text}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C5603AQE4DiLxhSzZTw/profile-displayphoto-shrink_800_800/0/1517064860289?e=1699488000&v=beta&t=qqke3ISXWT4g1QvKUL2_LTWnKzS1x200O9E1GmqicVU"
                  className={styles.photo}
                />
                <div className={styles.text}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/D5603AQEmtCDQdMCuwg/profile-displayphoto-shrink_800_800/0/1668413121066?e=1699488000&v=beta&t=PGXqLXTGz1QwgKx_aOhKAEN3Z7KWMcbU4pWxMvArzoo"
                  className={styles.photo}
                />
                <div className={styles.text}>
                  <p className={styles.name}>Sumit Kumar</p>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C5603AQGwnfjTsggCdA/profile-displayphoto-shrink_800_800/0/1651814685060?e=1699488000&v=beta&t=VRtufwohh_zFGeoO9RY8Am8Ah85wC6bHUoPEzW2_M7k"
                  className={styles.photo}
                />
                <div className={styles.text}>
              ...
              <div className={styles.people}>
                <img
                  alt=""
                  src="https://media.licdn.com/dms/image/C5603AQH2c7mrQ_d1Mw/profile-displayphoto-shrink_800_800/0/1632067553632?e=1699488000&v=beta&t=9r6pvwrSbHom5g3fhJldMrYn1LAnsgIyPjGgooAfR18"
                  className={styles.photo}
                />
                <div className={styles.text}>
